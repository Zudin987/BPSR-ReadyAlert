...
use windows_sys::Win32::{
    ...
    Graphics::Gdi::{SetBkColor, SetBkMode, SetTextColor, HDC, TRANSPARENT},
    System::LibraryLoader::GetModuleHandleW,
    UI::WindowsAndMessaging::{
        CreateWindowExW, DefWindowProcW, DestroyWindow, GetClientRect, GetDlgItem, GetWindowTextLengthW,
        GetWindowTextW, IsWindow, LoadCursorW, RegisterClassW,
...
pub unsafe fn show(owner: HWND) {
    ...
    if CLASS_READY.get().is_none() {
        ...
        let wc = WNDCLASSW {
            ...
            hbrBackground: crate::ui_modern::mist_bg_brush(),
    ...
    let hwnd = CreateWindowExW(
        ...
        owner, null_mut(), instance, null_mut(),
    );
...
unsafe extern "system" fn wnd_proc(hwnd: HWND, msg: u32, wparam: WPARAM, lparam: LPARAM) -> LRESULT {
    if msg == WM_NCCREATE {
        ...
        if !create.is_null() {
            windows_sys::Win32::UI::WindowsAndMessaging::SetWindowLongPtrW(hwnd, GWLP_USERDATA, (*create).lpCreateParams as isize);
        }
    }
    match msg {
        WM_CREATE => {
        ...
        WM_ERASEBKGND => {
            ...
            crate::ui_modern::fill_mist_background(wparam as HDC, &rect);
            1
        }
        WM_CTLCOLORSTATIC => {
            let hdc = wparam as HDC;
            SetBkMode(hdc, TRANSPARENT as i32);
            SetTextColor(hdc, crate::ui_modern::BPSR_TEXT_SECONDARY);
            crate::ui_modern::mist_bg_brush() as LRESULT
        }
        WM_CTLCOLOREDIT => {
            let hdc = wparam as HDC;
            SetBkColor(hdc, crate::ui_modern::MIST_INPUT);
